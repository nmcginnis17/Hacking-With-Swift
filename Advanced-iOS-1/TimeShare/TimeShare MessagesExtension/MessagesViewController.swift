...
class MessagesViewController: MSMessagesAppViewController {
    ...
    func createMessage(with dates: [Date], votes: [Int]) {
        ...
        // sanity check to make sure we have a conversation to work with
        ...
        // create new message from session and assign it the URL we created from our dates and votes
        let message = MSMessage(session: session)
        message.url = components.url
        
        // create blank, default message layout
    ...
    func render(dates: [Date]) -> UIImage {
        ...
        // create attributes for drawing using Dynamic Type so that we respect the users font choices
        ...
        // make single string out of all dates
        var stringToRender = ""
        ...
        // trim last line break then create attributed string by merging the date string and attributes
        ...
        // calculate size required to draw attributed string, then add the inset to all edges
        var imageSize = attributedString.size()
        imageSize.width += inset * 2
        imageSize.height += inset * 2
        
        // create image format that uses @3x scale on opaque background
        let format = UIGraphicsImageRendererFormat()
        format.opaque = true
        format.scale = 3
        
        // create render at the correct size, using above format
        ...
        let image = renderer.image { ctx in
            ...
            // render our text on top using insets we created
